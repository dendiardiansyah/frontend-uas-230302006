<div class="row justify-content-center">
    <div class="col-md-10 d-flex justify-content-center">
        <div class="card p-4"
            ...
            <h3 class="text-center fw-bold mb-4">Edit Data Mahasiswa</h3>
            ...
            <form action="{{ route('mahasiswa.update', $mahasiswa['nim']) }}" method="POST">
                ...
                <div class="form-group">
                    <label for="nama" class="form-label fw-semibold" style="font-size: 16px;">Nama Mahasiswa</label>
                ...
                <div class="form-group mt-3">
                    <label for="nidn" class="form-label fw-semibold" style="font-size: 16px;">NIM</label>
